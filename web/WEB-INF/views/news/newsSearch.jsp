...
<div class="container" style>
			<ul id="gn-menu" class="gn-menu-main">
				...
				<li>
				<!-- <div id="header" class="whitebar jbFixed" style='width:100%;  height:72px;background-color:#DEECEF'> -->
          		  <!-- <a> -->
<!--           		  <div>
				  <form method="GET" action="news/searchNews.do" name="searchForm" >
	      		  <input id="mainSearchTextbox" class="form-control mr-sm-2" type="text" placeHolder="키워드를 입력해 주세요." name="searchWord"/>
	       		  <button type="button" id="mainSearchButton" class="btn btn-secondary my-2 my-sm-0" onclick= "searchArticle()"></button>
	      		  </form>
	  	    	  <button type="button" id="btnGroupDrop3" class="btn btn-primary dropdown-toggle" onclick="showOption()"></button>
	  	    	  </div> -->
	   			  <!-- </a> -->
	 		<!--   </div> -->
	 		  </li>
